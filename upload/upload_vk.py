...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Emma Stone Daily!\n\n#emmastone #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Emma Stone Daily Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Emma Stone Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Emma Stone Daily"
